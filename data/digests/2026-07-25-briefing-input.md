# AI Engineering Newsletter - 2026-07-25
...
1. [Quoting Boris Cherny](https://simonwillison.net/2026/Jul/25/boris-cherny)
   ...
   - score: 64.363
   - score_breakdown: general=0.667; engineering=0.0; research=0.0; novelty=0.865; source_priority=1.0
...
2. [[AINews] Claude Opus 5: Fable-level performance at Opus price (half Fable)](https://www.latent.space/p/ainews-claude-opus-5-fable-level)
   - source: Latent Space
   - score: 63.336
   - score_breakdown: general=0.5; engineering=0.0; research=0.0; novelty=0.97; source_priority=1.0
...
3. [Introducing Claude Opus 5 on AWS: Anthropic’s most capable Opus model](https://aws.amazon.com/blogs/machine-learning/introducing-claude-opus-5-on-aws-anthropics-most-capable-opus-model)
   ...
   - score: 67.144
   - score_breakdown: general=0.833; engineering=0.0; research=0.0; novelty=0.84; source_priority=1.0
...
6. [QR Codes Make Their Way Down Wedding Aisles](https://www.nytimes.com/2026/07/25/style/wedding-qr-codes.html)
...
7. [As US weighs response to Chinese AI, industry urges against broad open-weight restrictions](https://techcrunch.com/2026/07/24/as-us-weighs-response-to-chinese-ai-industry-urges-against-broad-open-weight-restrictions)
   - source: TechCrunch AI
   - score: 56.658
...
8. [Anthropic releases Opus 5 with ‘close’ to Fable 5’s capabilities](https://www.theverge.com/ai-artificial-intelligence/970105/claude-opus-5-announced-anthropic-ai-model-release)
   - source: The Verge AI
   - score: 56.087
   - score_breakdown: general=0.667; engineering=0.0; research=0.0; novelty=0.489; source_priority=1.0
   - reasons: source_priority=1.00; novelty=0.49; matched_terms=4; engineering_relevance=0.00; research_relevance=0.00; visible_engagement=unavailable
9. [Start Customizing NVIDIA Nemotron 3 Nano with Prime Intellect Lab in Minutes](https://developer.nvidia.com/blog/start-customizing-nvidia-nemotron-3-nano-with-prime-intellect-lab-in-minutes)
   - source: NVIDIA AI
   - score: 51.189
   - score_breakdown: general=0.333; engineering=0.0; research=0.0; novelty=0.569; source_priority=1.0
...
10. [Studio Build, test, and run AI agents and apps.](https://mistral.ai/products/studio)
   - source: Mistral AI
   - score: 49.7
...
1. [AI Physics for Automotive Crash and Structural FEA Simulations](https://rescale.com/blog/ai-physics-automotive-crash-structural-fea-simulations)
   - source: Rescale
   - score: 80.809
   - score_breakdown: general=0.667; engineering=1.0; research=0.0; novelty=0.976; source_priority=1.0
...
2. [Introducing Claude Opus 5](https://simonwillison.net/2026/Jul/24/introducing-claude-opus-5)
   - source: Simon Willison
   - score: 67.553
   - score_breakdown: general=0.667; engineering=0.25; research=0.0; novelty=0.851; source_priority=1.0
   - reasons: source_priority=1.00; novelty=0.85; matched_terms=4; engineering_relevance=0.25; research_relevance=0.00; visible_engagement=unavailable
3. [‘I thought, I’ve tried everything else, why not give AI a shot?’: the long-lost family reunited by ChatGPT](https://www.theguardian.com/lifeandstyle/ng-interactive/2026/jul/25/long-lost-family-reunited-chatgpt-artificial-intelligence-ai)
   ...
   - score: 61.344
   - score_breakdown: general=0.167; engineering=0.5; research=0.0; novelty=0.864; source_priority=1.0
   - reasons: source_priority=1.00; novelty=0.86; matched_terms=1; engineering_relevance=0.50; research_relevance=0.00; visible_engagement=unavailable
...
5. [Dynamic Simulation In Engineering Techniques And Applications](https://www.neuralconcept.com/post/dynamic-simulation-in-engineering-techniques-and-applications)
...
1. [FDA advisory panel narrowly rejects compounding of one peptide, backs two others](https://www.statnews.com/2026/07/24/fda-peptide-compounding-panel-backs-epitalon-rejects-emideltide)
   ...
   - score: 47.254
   - score_breakdown: general=0.167; engineering=0.0; research=0.0; novelty=0.542; source_priority=1.0
...
4. [Aichemy How Mcp Powered Agents Cut Drug Discovery Research Weeks Minutes](https://www.databricks.com/dataaisummit/session/aichemy-how-mcp-powered-agents-cut-drug-discovery-research-weeks-minutes)
   - source: Databricks AI
   - score: 37.833
   - score_breakdown: general=0.333; engineering=0.0; research=0.333; novelty=0.35; source_priority=0.65
   - reasons: source_priority=0.65; novelty=0.35; matched_terms=2; engineering_relevance=0.00; research_relevance=0.33; visible_engagement=unavailable
5. [2136069.Article](https://www.drugtargetreview.com/3d-genome-reorganisation-identified-as-alzheimers-disease-molecular-hallmark/2136069.article)
...
2. [Cross Origin Storage](https://huggingface.co/blog/cross-origin-storage)
   ...
   - score: 51.033
   - score_breakdown: general=0.167; engineering=0.0; research=1.0; novelty=0.35; source_priority=1.0
3. [Vllm Colocate](https://huggingface.co/blog/vllm-colocate)
   - source: Hugging Face Papers
   - score: 51.033
   - score_breakdown: general=0.167; engineering=0.0; research=1.0; novelty=0.35; source_priority=1.0
4. [Llm Performance Prefill Decode Concurrent Requests](https://huggingface.co/blog/tngtech/llm-performance-prefill-decode-concurrent-requests)
   - source: Hugging Face Papers
   - score: 51.033
   - score_breakdown: general=0.167; engineering=0.0; research=1.0; novelty=0.35; source_priority=1.0
5. [Hugging Face Pollen Robotics Acquisition](https://huggingface.co/blog/hugging-face-pollen-robotics-acquisition)
   - source: Hugging Face Papers
   - score: 51.033
   - score_breakdown: general=0.167; engineering=0.0; research=1.0; novelty=0.35; source_priority=1.0
