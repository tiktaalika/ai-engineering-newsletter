# AI Engineering Newsletter - 2026-08-05
...
2. [llm 0.32](https://simonwillison.net/2026/Aug/4/llm)
   ...
   - score: 54.82
   - score_breakdown: general=0.333; engineering=0.0; research=0.0; novelty=0.734; source_priority=1.0
...
10. [OpenAI pays $3.2m to settle claims it discriminated against US workers](https://www.theguardian.com/us-news/2026/aug/04/openai-worker-discrimination-claims-settlement)
   - source: The Guardian Technology
   - score: 60.819
   - score_breakdown: general=0.667; engineering=0.0; research=0.0; novelty=0.704; source_priority=1.0
...
1. [New release of LLM adds support for reasoning traces, OpenAI Responses, server-side tools, and smarter logging](https://simonwillison.net/2026/Aug/4/new-release-of-llm)
   ...
   - reasons: source_priority=1.00; novelty=0.84; matched_terms=7; engineering_relevance=0.25; research_relevance=0.67; visible_engagement=unavailable
2. [What’s new in Simcenter PhysicsAI 2026.1?](https://blogs.sw.siemens.com/simcenter/whats-new-in-simcenter-physicsai-2026-1)
   ...
   - score: 67.642
   - score_breakdown: general=0.167; engineering=1.0; research=0.0; novelty=0.832; source_priority=1.0
...
3. [2026 08 04 Synopsys Expands Global Collaboration With Murata To Accelerate Simulation Driven Innovation](https://www.synopsys.com/ja-jp/japan/press-releases/2026-08-04-synopsys-expands-global-collaboration-with-murata-to-accelerate-simulation-driven-innovation.html)
   - source: Synopsys
   - score: 58.996
   - score_breakdown: general=0.167; engineering=1.0; research=0.0; novelty=0.948; source_priority=0.65
...
4. [Phylo Chugai Ai Platform Drug Discovery](https://www.pharmaceutical-technology.com/news/phylo-chugai-ai-platform-drug-discovery)
   ...
   - score: 45.209
   - score_breakdown: general=0.167; engineering=0.0; research=0.0; novelty=0.958; source_priority=0.65
   - reasons: source_priority=0.65; novelty=0.96; matched_terms=1; engineering_relevance=0.00; research_relevance=0.00; visible_engagement=unavailable
...
## Research Radar
1. [Rapidfireai](https://huggingface.co/blog/rapidfireai)
   - source: Hugging Face Papers
   - score: 51.033
   - score_breakdown: general=0.167; engineering=0.0; research=1.0; novelty=0.35; source_priority=1.0
2. [Apriel H1](https://huggingface.co/blog/ServiceNow-AI/apriel-h1)
   - source: Hugging Face Papers
   - score: 51.033
   - score_breakdown: general=0.167; engineering=0.0; research=1.0; novelty=0.35; source_priority=1.0
3. [Aligning To What](https://huggingface.co/blog/MiniMax-AI/aligning-to-what)
   - source: Hugging Face Papers
   - score: 51.033
   - score_breakdown: general=0.167; engineering=0.0; research=1.0; novelty=0.35; source_priority=1.0
4. [Aisheets Unlock Images](https://huggingface.co/blog/aisheets-unlock-images)
   - source: Hugging Face Papers
   - score: 51.033
   - score_breakdown: general=0.167; engineering=0.0; research=1.0; novelty=0.35; source_priority=1.0
5. [Ai For Food Allergies](https://huggingface.co/blog/hugging-science/ai-for-food-allergies)
   - source: Hugging Face Papers
   - score: 51.033
   - score_breakdown: general=0.167; engineering=0.0; research=1.0; novelty=0.35; source_priority=1.0
