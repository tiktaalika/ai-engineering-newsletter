# AI Engineering Newsletter - 2026-08-23
...
4. [Inherent, founded by DeepMind alumni, says its AI ‘teammate’ just outperformed Anthropic and OpenAI at replicating research](https://techcrunch.com/2026/08/22/inherent-founded-by-deepmind-alumni-says-its-ai-teammate-just-outperformed-anthropic-and-openai-at-replicating-research)
   ...
   - score: 73.447
   - score_breakdown: general=0.833; engineering=0.0; research=0.667; novelty=0.884; source_priority=1.0
   - reasons: source_priority=1.00; novelty=0.88; matched_terms=5; engineering_relevance=0.00; research_relevance=0.67; visible_engagement=unavailable
...
7. [Four Years Ago, a Crypto Boss Went Missing. Now His Successor Has.](https://www.nytimes.com/2026/08/23/world/europe/poland-estonia-cryptocurrency.html)
...
8. [Sleeper Agents Training Deceptive Llms That Persist Through Safety Training](https://www.anthropic.com/research/sleeper-agents-training-deceptive-llms-that-persist-through-safety-training)
   - source: Anthropic
   - score: 55.7
...
9. [Accelerating aircraft IFEC diagnostics with agentic AI on AWS](https://aws.amazon.com/blogs/machine-learning/accelerating-aircraft-ifec-diagnostics-with-agentic-ai-on-aws)
   - source: Amazon AWS AI
   - score: 55.478
   - score_breakdown: general=0.5; engineering=0.0; research=0.0; novelty=0.613; source_priority=1.0
   - reasons: source_priority=1.00; novelty=0.61; matched_terms=3; engineering_relevance=0.00; research_relevance=0.00; visible_engagement=unavailable
10. [Maximizing AI Factory Performance per Watt with NVIDIA DSX MaxLPS](https://developer.nvidia.com/blog/maximizing-ai-factory-performance-per-watt-with-nvidia-dsx-maxlps)
   - source: NVIDIA AI
   - score: 55.031
   - score_breakdown: general=0.5; engineering=0.0; research=0.0; novelty=0.592; source_priority=1.0
...
2. [Fea Execution On Remote Servers](https://www.synera.ai/workflows/fea-execution-on-remote-servers)
   - source: Synera
   - score: 57.033
   - score_breakdown: general=0.167; engineering=1.0; research=0.0; novelty=0.35; source_priority=1.0
   - reasons: source_priority=1.00; novelty=0.35; matched_terms=1; engineering_relevance=1.00; research_relevance=0.00; visible_engagement=unavailable
3. [Ai In Cae](https://www.neuralconcept.com/post/ai-in-cae)
...
4. [[AINews] 10% worse, 100x cheaper, 10000x faster: Why Simulation is taking over](https://www.latent.space/p/ainews-10-worse-100x-cheaper-10000x)
   - source: Latent Space
   - score: 53.085
   - score_breakdown: general=0.167; engineering=0.25; research=0.0; novelty=0.648; source_priority=1.0
   - reasons: source_priority=1.00; novelty=0.65; matched_terms=1; engineering_relevance=0.25; research_relevance=0.00; visible_engagement=unavailable
...
1. [Deepcell, Gilead Sciences Ink Deal to Develop Single-Cell Morphology AI Foundation Model](https://www.genomeweb.com/informatics/deepcell-gilead-sciences-ink-deal-develop-single-cell-morphology-ai-foundation-model)
   - source: GenomeWeb
   - score: 35.167
...
2. [Proteins Tied to Heart Failure, Adverse Social Determinants of Health in Blood Proteome Study](https://www.genomeweb.com/proteomics-protein-research/proteins-tied-heart-failure-adverse-social-determinants-health-blood)
   - source: GenomeWeb
   - score: 34.5
...
3. [Bioptimus, UK's Cancer Research Horizons Partner to Expand Spatial Tissue Atlas for AI Model](https://www.genomeweb.com/cancer/bioptimus-uks-cancer-research-horizons-partner-expand-spatial-tissue-atlas-ai-model)
   - source: GenomeWeb
   - score: 34.5
   - score_breakdown: general=0.167; engineering=0.0; research=0.333; novelty=0.35; source_priority=0.65
   - reasons: source_priority=0.65; novelty=0.35; matched_terms=1; engineering_relevance=0.00; research_relevance=0.33; visible_engagement=unavailable
4. [Keeping Ai Safe Healthcare Evaluation Strategies Production Ready](https://www.databricks.com/dataaisummit/session/keeping-ai-safe-healthcare-evaluation-strategies-production-ready)
...
5. [Ambros Werewolf Therapeutics Reverse Merger Chronic Pain Neridronate Abiogen Crps 1 Ambx](https://medcitynews.com/2026/08/ambros-werewolf-therapeutics-reverse-merger-chronic-pain-neridronate-abiogen-crps-1-ambx)
   - source: MedCity News
   - score: 31.833
   - score_breakdown: general=0.167; engineering=0.0; research=0.0; novelty=0.35; source_priority=0.65
   - reasons: source_priority=0.65; novelty=0.35; matched_terms=1; engineering_relevance=0.00; research_relevance=0.00; visible_engagement=unavailable
...
3. [Lfm25 Dspark](https://huggingface.co/blog/LiquidAI/lfm25-dspark)
   - source: Hugging Face Papers
   - score: 51.033
   - score_breakdown: general=0.167; engineering=0.0; research=1.0; novelty=0.35; source_priority=1.0
4. [Async Robot Inference](https://huggingface.co/blog/async-robot-inference)
   ...
   - score: 51.033
   - score_breakdown: general=0.167; engineering=0.0; research=1.0; novelty=0.35; source_priority=1.0
5. [Azure Ai Foundry](https://huggingface.co/blog/azure-ai-foundry)
   - source: Hugging Face Papers
   - score: 51.033
   - score_breakdown: general=0.167; engineering=0.0; research=1.0; novelty=0.35; source_priority=1.0
