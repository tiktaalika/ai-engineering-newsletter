# AI Engineering Newsletter - 2026-08-10
...
1. [GitHub Models is now retired](https://simonwillison.net/2026/Aug/9/github-models-is-now-retired)
   ...
   - score: 67.476
   - score_breakdown: general=0.667; engineering=0.0; research=0.333; novelty=0.885; source_priority=1.0
...
2. [Quoting Claude Opus 5 system prompt](https://simonwillison.net/2026/Aug/9/claude-opus-5-system-prompt)
   - source: Simon Willison
   - score: 65.059
   - score_breakdown: general=0.667; engineering=0.0; research=0.0; novelty=0.897; source_priority=1.0
...
3. [The AI safety test is becoming a safety risk](https://techcrunch.com/2026/08/09/the-ai-safety-test-is-becoming-a-safety-risk)
   ...
   - score: 63.749
   - score_breakdown: general=0.667; engineering=0.0; research=0.0; novelty=0.837; source_priority=1.0
...
4. [Anthropic is turning Claude Code’s auto mode on by default](https://techcrunch.com/2026/08/09/anthropic-is-turning-claude-codes-auto-mode-on-by-default)
   - source: TechCrunch AI
   - score: 58.192
   - score_breakdown: general=0.333; engineering=0.0; research=0.0; novelty=0.887; source_priority=1.0
...
5. [Australia news live: Two workers were temporarily stood down over airport near-miss; Albanese confirms Labor will amend gambling legislation](https://www.theguardian.com/australia-news/live/2026/aug/10/australia-news-live-transport-minister-sydney-airport-air-traffic-control-catherine-king-aukus-public-inquiry-malcolm-turnbull-alan-jones-trial-ntwnfb)
...
10. [Microsoft Nvidia Anthropic Announce Strategic Partnerships](https://www.anthropic.com/news/microsoft-nvidia-anthropic-announce-strategic-partnerships)
   - source: Anthropic
   - score: 46.367
   - score_breakdown: general=0.333; engineering=0.0; research=0.0; novelty=0.35; source_priority=1.0
   - reasons: source_priority=1.00; novelty=0.35; matched_terms=2; engineering_relevance=0.00; research_relevance=0.00; visible_engagement=unavailable
...
1. [Agentic Ai Cae Manufacturing Analysis Automotive Cae Grand Challenge](https://www.synera.ai/webinar/agentic-ai-cae-manufacturing-analysis-automotive-cae-grand-challenge)
   - source: Synera
   - score: 67.033
...
2. [Nafems Sweden Ai And Ml In Simulation Driven Design](https://www.neuralconcept.com/post/nafems-sweden-ai-and-ml-in-simulation-driven-design)
...
3. [Ntop Live Automated Reconstruction Of Topology Optimization From Altair Optistruct In Ntopology](https://www.ntop.com/resources/videos/ntop-live-automated-reconstruction-of-topology-optimization-from-altair-optistruct-in-ntopology)
   - source: nTop
   - score: 49.167
...
4. [How Is Minimum Member Size Control Implemented In Generative Design To Prevent Parts From Failing During Casting Or Milling](https://www.colabsoftware.com/faqs/how-is-minimum-member-size-control-implemented-in-generative-design-to-prevent-parts-from-failing-during-casting-or-milling)
   - source: CoLab Software
   - score: 49.167
   - score_breakdown: general=0.333; engineering=1.0; research=0.0; novelty=0.35; source_priority=0.65
   - reasons: source_priority=0.65; novelty=0.35; matched_terms=2; engineering_relevance=1.00; research_relevance=0.00; visible_engagement=unavailable
5. [Simulation Service](https://www.siemens-energy.com/us/en/home/products-services/service/basic-research/simulation-service.html)
...
2. [Agent Logic And Scalable Ai Adoption](https://huggingface.co/blog/ibm-research/agent-logic-and-scalable-ai-adoption)
   - source: Hugging Face Papers
   - score: 54.367
   - score_breakdown: general=0.333; engineering=0.0; research=1.0; novelty=0.35; source_priority=1.0
3. [Tutormoments](https://huggingface.co/blog/allenai/tutormoments)
   - source: Hugging Face Papers
   - score: 51.033
   - score_breakdown: general=0.167; engineering=0.0; research=1.0; novelty=0.35; source_priority=1.0
