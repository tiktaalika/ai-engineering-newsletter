...
1. [AgentHands: Generating interactive hand gestures for spatially grounded agent conversations in XR](https://research.google/blog/agenthands-generating-interactive-hand-gestures-for-spatially-grounded-agent-conversations-in-xr)
   ...
   - score: 64.036
   - score_breakdown: general=0.167; engineering=0.0; research=1.0; novelty=0.941; source_priority=1.0
...
5. [Disrupting a new covert influence campaign from Russia](https://openai.com/index/disrupting-malicious-uses-of-ai-influence-campaign-russia)
   - source: OpenAI
   - score: 53.243
   - score_breakdown: general=0.333; engineering=0.0; research=0.0; novelty=0.663; source_priority=1.0
...
6. [Why Ramp built its own in-house coding agent, Inspect](https://newsletter.pragmaticengineer.com/p/why-ramp-built-inspect)
   ...
   - score: 43.605
   - score_breakdown: general=0.333; engineering=0.0; research=0.0; novelty=0.734; source_priority=0.65
...
7. [Jalapeño’s first results show industry-leading speed and efficiency in AI inference](https://openai.com/index/jalapeno-first-results)
   - source: OpenAI
   - score: 58.181
   - score_breakdown: general=0.5; engineering=0.0; research=0.0; novelty=0.735; source_priority=1.0
...
8. [Granite 4.2 LLMs: How They're Built](https://huggingface.co/blog/ibm-granite/granite-4-2)
   - source: Hugging Face
   - score: 51.436
...
9. [Restore LLM Inference Capacity in Seconds with Shadow Engine Recovery in NVIDIA Dynamo](https://developer.nvidia.com/blog/restore-llm-inference-capacity-in-seconds-with-shadow-engine-recovery-in-nvidia-dynamo)
   - source: NVIDIA AI
   - score: 68.048
   - score_breakdown: general=0.833; engineering=0.0; research=0.0; novelty=0.881; source_priority=1.0
...
10. [OpenAI’s Jalapeño chip is built for fast inference at scale, benchmarks show](https://techcrunch.com/2026/08/25/openais-jalapeno-chip-is-built-for-fast-inference-at-scale-benchmarks-show)
...
3. [Cae Tools Used In Automotive Industry](https://www.neuralconcept.com/post/cae-tools-used-in-automotive-industry)
...
4. [In China, talking to AI is normal. Now the government fears it might replace human intimacy](https://www.theguardian.com/world/2026/aug/26/china-ai-companion-relationships-marriage-birth-rate-concern)
   ...
   - score: 55.609
   - score_breakdown: general=0.167; engineering=0.25; research=0.0; novelty=0.763; source_priority=1.0
...
5. [AI Companion Robots Are Closing the Human Connection in Modern Homes](https://spectrum.ieee.org/ollobot-ai-companion-robot)
   ...
   - score: 54.772
   - score_breakdown: general=0.5; engineering=0.25; research=0.333; novelty=0.3; source_priority=1.0
   - reasons: source_priority=1.00; novelty=0.30; matched_terms=3; engineering_relevance=0.25; research_relevance=0.33; visible_engagement=unavailable
...
1. [Amping up T cells to target cancer](https://www.technologyreview.com/2026/08/25/1140949/amping-up-t-cells-to-target-cancer)
   ...
   - score: 52.167
   - score_breakdown: general=0.167; engineering=0.0; research=0.333; novelty=0.644; source_priority=1.0
...
2. [STAT+: FDA promises new AI guidance, and what happened at Epic’s UGM](https://www.statnews.com/2026/08/25/fda-promises-new-ai-guidance-and-epic-ugm-updates)
   ...
   - score: 47.846
   - score_breakdown: general=0.333; engineering=0.0; research=0.0; novelty=0.417; source_priority=1.0
