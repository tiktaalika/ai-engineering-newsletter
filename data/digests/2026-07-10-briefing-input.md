...
4. [Introducing Muse Spark 1.1](https://simonwillison.net/2026/Jul/9/muse-spark-1-1)
   ...
   - score: 57.986
   - score_breakdown: general=0.5; engineering=0.0; research=0.0; novelty=0.727; source_priority=1.0
...
1. [The new GPT-5.6 family: Luna, Terra, Sol](https://simonwillison.net/2026/Jul/9/gpt-5-6)
   - source: Simon Willison
   - score: 75.313
   - score_breakdown: general=1.0; engineering=0.25; research=0.333; novelty=0.779; source_priority=1.0
...
2. [Large Tabular Models Excel Where LLMs Fail](https://spectrum.ieee.org/large-tabular-models-nexus)
   ...
   - score: 70.446
   - score_breakdown: general=1.0; engineering=0.25; research=1.0; novelty=0.316; source_priority=1.0
   - reasons: source_priority=1.00; novelty=0.32; matched_terms=9; engineering_relevance=0.25; research_relevance=1.00; visible_engagement=unavailable
...
4. [OpenAI is shutting down Atlas, but its AI browser ambitions are still growing](https://techcrunch.com/2026/07/09/openai-is-shutting-down-atlas-but-its-ai-browser-ambitions-are-still-growing)
   ...
   - score: 64.788
   - score_breakdown: general=0.5; engineering=0.25; research=0.0; novelty=0.877; source_priority=1.0
...
5. [Agentic Simulation Report Generation](https://rescale.com/blog/agentic-simulation-report-generation)
   - source: Rescale
   - score: 63.228
   - score_breakdown: general=0.167; engineering=1.0; research=0.0; novelty=0.632; source_priority=1.0
...
2. [Aurora 1.5: Extending open foundation models for weather and Earth-system applications](https://www.microsoft.com/en-us/research/blog/aurora-1-5-extending-open-foundation-models-for-weather-and-earth-system-applications)
   ...
   - score: 63.651
   - score_breakdown: general=0.167; engineering=0.0; research=1.0; novelty=0.924; source_priority=1.0
